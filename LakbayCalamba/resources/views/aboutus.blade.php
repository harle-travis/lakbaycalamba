...
<div class="relative bg-gradient-to-br from-blue-500 to-blue-600 min-h-[50vh] sm:min-h-[60vh] flex items-center rounded-2xl mx-4 sm:mx-6">
    <!-- Background Image -->
    <img src="/images/jose_rizal.png" alt="Jose Rizal" class="absolute inset-0 w-full h-full object-cover opacity-30 select-none pointer-events-none" style="object-position: center 15%;" />
            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-12">
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base leading-snug text-justify mt-1">
                        Our mission is to promote local tourism in Calamba by using digital tools that make exploring
        ...
        <div class="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div class="w-full">
                <div class="rounded-2xl shadow-md overflow-hidden border border-gray-200">
                    <img src="/images/calambamap.png" alt="Calamba map" class="w-full h-56 sm:h-72 md:h-80 object-cover" />
                </div>
            </div>
        </div>
